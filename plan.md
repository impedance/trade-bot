...
- [ ] Извлечение VBA-кода из `xl/vbaProject.bin` в текст `.bas/.cls/.frm` (нужно средство `olevba/vbac`).
- [ ] Поиск точек интеграции QUIK DDE/ODBC (каналы, топики, DDE-ссылки в листах).
